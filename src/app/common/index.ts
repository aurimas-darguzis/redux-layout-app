// Import createSelector from reselect to make selection of different parts of the state efficient
...
export const getLayouOpenedModalName = createSelector(getLayoutState, fromLayout.getOpenedModalName);
